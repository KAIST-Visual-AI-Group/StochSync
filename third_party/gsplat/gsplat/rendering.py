...
def rasterization(
    ...
    if colors.shape[-1] > 32:
        ...
        for i in range(n_chunks):
            ...
            render_colors_, render_alphas_, gs_weights_ = rasterize_to_pixels(
                means2d,
                conics,
                colors_chunk,
                opacities,
        ...
        render_colors, render_alphas, gs_weights = rasterize_to_pixels(
            means2d,
            conics,
            colors,
            opacities,
    ...
    assert gs_weights.shape == (N,), gs_weights.shape
    meta = {
        "camera_ids": camera_ids,
        "gaussian_ids": gaussian_ids,
        "radii": radii,
