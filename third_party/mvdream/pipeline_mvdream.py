...
class MVDreamPipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        ...
        # Reverse the order of the prompt embeddings to match the order of the latents
        # following the diffuser's convention
        neg_prompt_embeds, pos_prompt_embeds = prompt_embeds.chunk(2)
        prompt_embeds = torch.cat([pos_prompt_embeds, neg_prompt_embeds])
        return prompt_embeds
